(function () {
	...
	class Cube {
	    ...
	    resetColorsToStart() {
	        ...
	        this.pieces.forEach(piece => piece.userData.cube.material.color.setHex(0x08101a));
	        this.edges.forEach(edge => edge.material.color.setHex(0xfff7ff));
	...
	class Themes {
	    ...
	    constructor(game) {
	        ...
	        this.defaults = {
	            cube: {
	                ...
	                piece: 0x08101a, // single minicube, black
	                empty: 0xfff7ff, // empty square, white
	                X: 0x82ca38, // player 1 square, green
	                O: 0xff8c0a, // player 2 square, orange
	                backgr: 0xd1d5db, // background, gray
	            },
	            og_cube: {
	                U: 0xfff7ff, // white
	                D: 0xffef48, // yellow
	    ...
	    setTheme(theme = false, force = false) {
	        ...
	        this.game.cube.resetColorsToStart();
